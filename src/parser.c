...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(83),
  [36] = {.entry = {.count = 1, .reusable = false}}, SHIFT(57),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [40] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4),
  ...
  [66] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  [68] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [70] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2),
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(18),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(18),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__path, 2),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__path, 2), SHIFT_REPEAT(85),
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 1),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(115),
  [118] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_body, 1),
  [126] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_css_body, 1),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_javascript_body, 1),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_json_body, 1),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_xml_body, 1),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 4),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 3),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_item, 1),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 5),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 5),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__target_repeat1, 2), SHIFT_REPEAT(75),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__target_repeat1, 2),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__other_content, 5),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_item, 3),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xml_content, 5),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__javascript_content, 5),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_content, 5),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__css_content, 5),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__html_content, 5),
  [177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_request_line, 6),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_status_line, 6),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5),
  ...
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 5),
  ...
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xml_header_value, 1),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__javascript_header_value, 1),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [223] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reason, 1),
  [229] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 2),
  ...
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1),
