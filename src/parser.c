...
enum {
  ...
  aux_sym__target_repeat1 = 79,
  aux_sym_body_repeat1 = 80,
  aux_sym_body_repeat2 = 81,
};
...
static const char * const ts_field_names[] = {
  ...
  [field_javascript_body] = "javascript_body",
  [field_json_body] = "json_body",
  [field_xml_body] = "xml_body",
};
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(110)] = 992,
  [SMALL_STATE(111)] = 996,
  [SMALL_STATE(112)] = 1000,
  [SMALL_STATE(113)] = 1004,
  [SMALL_STATE(114)] = 1008,
  [SMALL_STATE(115)] = 1012,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(87),
  ...
  [44] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(116),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__path, 2),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__path, 2), SHIFT_REPEAT(104),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 1),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 1),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_body_repeat2, 2),
  [90] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_body_repeat2, 2), SHIFT_REPEAT(47),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__target_repeat1, 2), SHIFT_REPEAT(68),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__target_repeat1, 2),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 4),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_body_repeat1, 2), SHIFT_REPEAT(42),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 5),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 5),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_item, 1),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(105),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 3),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_body_repeat2, 1),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_body_repeat2, 1),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_body_repeat2, 2),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__json_content, 5),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__html_content, 5),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__other_content, 5),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query_item, 3),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__javascript_content, 5),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xml_content, 5),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_status_line, 6),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_request_line, 6),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, .production_id = 2),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, .production_id = 4),
  ...
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__xml_header_value, 1),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5, .production_id = 5),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5, .production_id = 6),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5, .production_id = 7),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5, .production_id = 8),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 5),
  [177] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__javascript_header_value, 1),
  ...
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, .production_id = 3),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 4, .production_id = 1),
  [203] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [205] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6, .production_id = 9),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6, .production_id = 10),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6, .production_id = 11),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6, .production_id = 12),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 6),
  ...
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1),
  [225] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 2),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__target, 5),
